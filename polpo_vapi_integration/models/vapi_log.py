...
class VapiLog(models.Model):
    ...
    state = fields.Selection([
        ...
        help="The current status of the call. 'Started' when initiated, 'In Progress' during the call, 'Ended' when "
             "completed, and 'Error' if there was an issue.")
    last_active = fields.Datetime("Last activity",
                                  help="Date and time of the last activity in the call, used to determine if the "
                                       "call is stuck")
