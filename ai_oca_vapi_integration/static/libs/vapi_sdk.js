(function (oe) {
    ...
    var Cl = (oe, ve, Ee) =>
        ve in oe
            ? Tl(oe, ve, {enumerable: !0, configurable: !0, writable: !0, value: Ee})
            : (oe[ve] = Ee);
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
            ...
            if (t === e || t.listener === e)
                ...
                i === 0
                    ...
                    r.removeListener !== void 0 &&
                        this.emit("removeListener", n, c || e);
            }
            return this;
        }),
    ...
    var Qs = [
        ...
        Xs = [
            ...
            {test: (n) => n.getOSName(!0) === "roku", describe: () => ({type: $.tv})},
        ],
        Zs = [
            {
    ...
    function na(n, e, t = 250, r, i, s, c) {
        if (!(s.exception && s.exception.values && c && xe(c.originalException, Error)))
            return;
        const l =
    ...
    function xr(n, e) {
        (n.mechanism = n.mechanism || {type: "generic", handled: !0}),
            (n.mechanism = {...n.mechanism, is_exception_group: !0, exception_id: e});
    }
    function jr(n, e, t, r) {
        (n.mechanism = n.mechanism || {type: "generic", handled: !0}),
            (n.mechanism = {
            ...
            (function (t) {
                ...
                return !(
                    ["protocol", "publicKey", "host", "projectId"].find(
                        (c) =>
                            !t[c] && (O.error(`Invalid Sentry Dsn: ${c} missing`), !0)
                    ) ||
                    (i.match(/^\d+$/)
                        ? (function (c) {
    ...
    function Yr(n) {
        if (Ir(n)) return {message: n.message, name: n.name, stack: n.stack, ...Gr(n)};
        if (Lt(n)) {
            const e = {
                type: n.type,
                target: $r(n.target),
...
Error:`,
    ...
    const ha = ["fatal", "error", "warning", "log", "info", "debug"],
        ...
        Zr = Cn === void 0 ? Tn : {nowSeconds: () => (Cn.timeOrigin + Cn.now()) / 1e3},
                ...
                if (t === null || typeof l != "function") s(t);
                    ...
                    (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
                        ...
                        dn(u)
                            ? u
                                  .then((h) =>
                                      this._notifyEventProcessors(e, h, r, i + 1).then(
                                          s
                                      )
                                  )
                                  .then(null, c)
                ...
                .then((m) => {
                    if (m === null)
                        throw (
                            ...
                            new le(
                                `${h} returned \`null\`, will not send event.`,
                                "log"
                            ))
                        );
                        ...
                        return (function (p, m) {
                            return m.ignoreInternal &&
                                (function (y) {
                                    try {
                                        return (
                                            y.exception.values[0].type === "SentryError"
                                        );
                                    } catch {}
                                    return !1;
                                })(p)
                                          ...
                                          : (function (b) {
                                                ...
                                                if (b.exception) {
                                                    ...
                                                    try {
                                                        ...
                                                        return (
                                                            (typeof __SENTRY_DEBUG__ >
                                                                "u" ||
                                                                __SENTRY_DEBUG__) &&
                                                                O.error(
                                                                    `Cannot extract message for event ${Ae(
                                                                        b
                                                                    )}`
                                                                ),
                                                            []
...
Url: ${Gt(p)}`),
    ...
    Xe.__initStatic();
    var Oa = Object.freeze({__proto__: null, FunctionToString: gt, InboundFilters: Xe});
    const F = ne;
    let Pn = 0;
    function yi() {
        return Pn > 0;
                ...
                throw (
                    ...
                    (s = (l) => {
                        ...
                        l.addEventProcessor(
                            (p) => (
                                e.mechanism &&
                                    (wn(p, void 0, void 0), ft(p, e.mechanism)),
    ...
    function Nn(n, e, t, r, i) {
        ...
        if (Dr(e) || ze(e, "DOMException")) {
            ...
            return (
                "code" in c && (s.tags = {...s.tags, "DOMException.code": `${c.code}`}),
                s
            );
        }
        return Ir(e)
            ...
            ? ((s = (function (c, l, u, h) {
              ...
              ft(s, {synthetic: !0}),
              s)
            : ((s = Rn(n, e, t, r)), wn(s, `${e}`, void 0), ft(s, {synthetic: !0}), s);
    }
    function Rn(n, e, t, r) {
        const i = {message: e};
        if (r && t) {
                        ...
                        r--,
                        {
                            ...
                            headers: {
                                "x-sentry-rate-limits":
                                    l.headers.get("X-Sentry-Rate-Limits"),
                        ...
                        r in t &&
                            ...
                            W(t, r, function (i) {
                                const s = {
                                    ...
                                    c = gn(i);
                                return (
                                    c && (s.mechanism.data.handler = Ce(c)), Ze(i, s)
                                );
                            });
                    }
                ),
            ...
            ae(t, [
                            ...
                            l = function (u) {
                                if (
                                    ...
                                    if (
                                        (delete h.from,
                                        h.callbackStamp &&
                                            c._messageCallbacks[h.callbackStamp])
                                    ) {
                ...
                },
                {
                    ...
                    value: function (r, i, s, c) {
                        ...
                        var l = Qn({}, r);
                        if (
                            ((l.what = $n), (l.from = "module"), (l.callFrameId = c), i)
                        ) {
                            var u = At();
                ...
                ae(t, [
                    ...
                    },
                    {
                        ...
                        value: function (r, i, s, c) {
                            ...
                            (this._wrappedListeners[r] = u),
                                i.addListener("message", u);
                        },
                    },
                    {
                        key: "_sendMessage",
        ...
        Ic = (function () {
            function n(s, c, l) {
                se(this, n),
                    ...
                    (this._iosCache =
                        typeof iOSCallObjectBundleCache < "u" &&
                            ...
                            ((t = C(function* (s) {
                                ...
                                try {
                                    ...
                                    Function('"use strict";' + h)(),
                                        this._iosCache &&
                                            this._iosCache.set(s, h, u.headers),
                                        (this.succeeded = !0),
                                        this._successCallback();
                                } catch (p) {
                                    if (
                        ...
                        value:
                            ((e = C(function* (s, c) {
                                ...
                                if (this._iosCache && c.status === 304)
                                    return (yield this._iosCache.renew(s, c.headers))
                                        .code;
                                throw new Error(
                                    "Received ".concat(c.status, " response")
                                );
                            })),
                            function (s, c) {
                                return e.apply(this, arguments);
                ...
                ae(n, [
                    {
                        ...
                        value: function () {
                            ...
                            (typeof document > "u" ? "undefined" : j(document)) ===
                            "object"
                    ...
                    return (
                        !!(function (t, r) {
                            try {
                                ...
                                return (
                                    console.error(
                                        "Failed to validate send settings",
                                        i
                                    ),
                                    !1
                                );
                ...
                ke(_e(a), "handleNativeAudioFocusChange", function (v) {
                    a.disableReactNativeAutoDeviceManagement("audio") ||
                        ...
                        a._hasNativeAudioFocus
                            ? a.micUnmutedBeforeLosingNativeAudioFocus &&
                              a.setLocalAudio(!0)
                            : ((a.micUnmutedBeforeLosingNativeAudioFocus =
                                  a.localAudio()),
                              a.setLocalAudio(!1)));
            ...
            ae(
                ...
                [
                        ...
                        value:
                            ((Js = C(function* () {
                                ...
                                try {
                                    ...
                                    console.log(
                                        "could not emit call-instance-destroyed"
                                    );
                                }
                                (fe = void 0),
                                    !(
                                        ...
                                        a.instances &&
                                        delete window._daily.instances[
                                            this._callFrameId
                                        ],
                    ...
                    },
                    {
                        ...
                        value: function () {
                            return (
                                me(this._callObjectMode, "accessState()"),
                                this._accessState
                            );
                        },
                    },
                    ...
                    },
                    {
                        ...
                        value: function (o, a) {
                            for (var d in a) {
                                if (!nn[d])
                                    throw new Error(
                                        "unrecognized updateParticipant property ".concat(
                                            d
                                        )
                                    );
                                if (
                        ...
                        value: function (o) {
                            ...
                            for (var d in o)
                                d === a && (d = "local"),
                                    d &&
                                        o[d] &&
                                        this.validateParticipantProperties(d, o[d]);
                            return (
                                this.sendMessageToCallMachine({
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this._inputSettings
                                ? ((o =
                                      ((d = this._inputSettings) === null ||
                                      d === void 0
                                          ? void 0
                                          : d.video) || P),
                                  (a =
                                      ((f = this._inputSettings) === null ||
                                      f === void 0
                                          ? void 0
                                          : f.audio) || P))
                                : ((o =
                                ...
                                if (
                                    ...
                                    return new Promise(function (d) {
                                        try {
                                            ...
                                            throw new Error(
                                                "Error setting user data: ".concat(f)
                                            );
                                        }
                                    });
                            })),
                        ...
                        value:
                            ((xs = C(function* (o) {
                                return (
                                    ...
                                    {
                                        deviceId:
                                            yield this.nativeUtils().getAudioDevice(),
                                    }
                                );
                            })),
                            function (o) {
                                        ...
                                        : ((this._iframe.src = Lr(
                                          ...
                                          new Promise(function (d, f) {
                                              a._loadedCallback = function (g) {
                                                  a._callState !== we
                                                      ? (a._updateCallState(Ni),
                                                        (a.properties.cssFile ||
                                                            a.properties.cssText) &&
                        ...
                        value:
                            ((De = C(function* () {
                                ...
                                return (
                                    ...
                                    new Promise(function (a) {
                                        if (o._callState === Se || o._callState === we)
                                            a();
                                        else if (
                                            o._callObjectLoader &&
                                ...
                                for (var f = 0; f < o.length; f++) {
                                    ...
                                    g))
                                        if (rr.includes(v)) {
                                            ...
                                            !["active", "scalabilityMode"].includes(v)
                                        )
                                            throw new Error(
                                                "Invalid key ".concat(
                                                    v,
                        ...
                        value:
                            ((L = C(function* (o) {
                                ...
                                try {
                                    ...
                                    throw (
                                        (console.error(
                                            "invalid argument Error: ".concat(v)
                                        ),
                        ...
                        value:
                            ((S = C(function* (o) {
                                ...
                                try {
                                    ...
                                    throw (
                                        (console.error(
                                            "invalid argument Error: ".concat(g)
                                        ),
                    ...
                    },
                    {
                        ...
                        value: function (o, a) {
                            ...
                            if (typeof a == "string") {
                                ...
                                if (
                                    a.maxQuality &&
                                    ["low", "medium", "high"].indexOf(a.maxQuality) ===
                                        -1
                                )
                                    throw new Error(
                    ...
                    },
                    {
                        ...
                        value:
                            ((c = C(function* () {
                                if (
                                    (I(),
                                    this._iframe && !document.fullscreenElement && xo())
                                )
                                    try {
                        ...
                        value:
                            ((i = C(function* () {
                                var o = this,
                                    ...
                                    d = a === void 0 || a;
                                return this._accessState.access === Jt ||
                                    this.needsLoad()
                                    ? this.properties.url
                        ...
                        value:
                            ((r = C(function* () {
                                try {
                                    ...
                                    return (
                                        console.error("geo lookup failed", a),
                                        {current: ""}
                                    );
                                }
                            })),
                    ...
                    },
                    {
                        ...
                        value: function (o) {
                            for (var a in o) {
                                if (!Ge[a])
                                    throw new Error(
                                        "unrecognized property '".concat(a, "'")
                                    );
                            ...
                            var o,
                                ...
                                d = A(
                                    ...
                                    {},
                                    {
                                        ...
                                        embHref: encodeURIComponent(
                                            window.location.href
                                        ),
                                        proxy:
                                            (o = this.properties.dailyConfig) !==
                                                null &&
                                            o !== void 0 &&
                                            o.proxyUrl
                                                ? encodeURIComponent(
                            ...
                            switch (o.action) {
                                ...
                                case Wi:
                                    if (o.participant && o.participant.session_id) {
                                        ...
                                        g &&
                                            this.maybeParticipantTracksStopped(g, null),
                                ...
                                case zi:
                                    if (
                                        !X(this._participantCounts, o.participantCounts)
                                    ) {
                                ...
                                case Hi:
                                    ...
                                    if (
                                        (o.awaitingAccess &&
                                            (v.awaitingAccess = o.awaitingAccess),
                                ...
                                case Qi:
                                    var cn =
                                        ...
                                        (o.meetingSessionState &&
                                            o.meetingSessionState.topology);
                                    (this._meetingSessionState = ar(
                                        o.meetingSessionState,
                                        this._callObjectMode
                                    )),
                                        (this._callObjectMode || cn) &&
                                            this.emitDailyJSEvent(o);
                                    break;
                                case fo:
                        ...
                        value: function (o, a, d, f) {
                            if (o && (o.readyState === "ended" || !a || o.id !== a.id))
                                try {
                                    ...
                                    console.log(
                                        "maybeEventTrackStopped: could not emit",
                                        g
                                    );
                                }
                        },
                        ...
                        value: function (o, a, d, f) {
                            if (a && (!o || o.readyState === "ended" || a.id !== o.id))
                                try {
                                    ...
                                    console.log(
                                        "maybeEventTrackStarted: could not emit",
                                        g
                                    );
                                }
                        },
                            ...
                            return (
                                ...
                                (!o.videoTrack ||
                                    ...
                                    (o.videoTrack.id === a.videoTrack.id &&
                                        ...
                                        o.videoTrack.enabled ===
                                            a.videoTrack.enabled)) &&
                                (!o.audioTrack ||
                                    !a.audioTrack ||
                            ...
                            if (
                                ...
                                o.error &&
                                    ...
                                    (q = o.error.details) !== null &&
                                        ...
                                        (Q.setTag(
                                            "bundleUrl",
                                            o.error.details.bundleUrl
                                        ),
                                        Q.setTag(
                                            "bundleError",
                                            o.error.details.sourceError.type
                                        ))),
                                    Q.setTags({
                    ...
                    !t ||
                        ...
                        typeof e != "string" ||
                            (!Object.values(Do).includes(e) &&
                                (console.error(
                                    "inputSettings audio processor type invalid"
                                ),
                                1)))))
            )
        );
            ...
            for (var e = 0, t = Object.entries(n); e < t.length; e++)
                for (
                    ...
                    if (
                        ...
                        return (
                            console.error(
                                "customTrayButton ".concat(l, " should be a url.")
                            ),
                            !1
                        );
                    var h = tn.id[l];
                    if (!h)
                        return (
                            console.error(
                                "customTrayButton does not support key ".concat(l)
                            ),
                            !1
                        );
                    if (j(u) !== h)
            ...
            var e = function (m) {
                ...
                t = function (m, y) {
                    return console.error(
                        "customIntegration ".concat(m, ": ").concat(y)
                    );
                },
                r = 0,
                i = Object.entries(n);
        ...
        const l = () => {
            s(e, "loading"),
                c
                    ...
                    : (t || r
                          ? n.start(t, r)
                          : (console.log("squad ,", i, t, r),
                            n.start(void 0, void 0, i)),
                      (c = !0));
        };
        n.on("call-start", () => {
            s(e, "active");
